...
Next steps:
- Captures let you store response values for later requests.
- Workflows chain requests with shared context.
- `resterm/rts/helpers.rts` shows a RestermScript module example.
